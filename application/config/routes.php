...
$route['pasteur/list'] = 'pasteur/pasteur/index';
$route['pasteur/detail/(:any)/(:num)'] = 'pasteur/pasteur/detailPasteur/$1/$2';
$route['pasteur/print/(:num)'] = 'pasteur/pasteur/printPasteur/$1';
