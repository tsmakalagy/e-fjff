	...
	<div class="col-md-7 col-md-offset-3">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title">Fokotany</h3>
			</div>
			<div class="panel-body">
				<form class="form col-md-12 center-block" id="firaisanaForm" method="post" action="">
					<div class="form-group">
						<select class="form-control input-lg firaisana-select" name="firaisana">
						  <option selected="selected">Select Firaisana</option>
						  <option>2</option>
						  <option>3</option>
						  <option>4</option>
						  <option>5</option>
...
$(function() {
	$(".firaisana-select").select2({minimumResultsForSearch: 10});
});
</script>