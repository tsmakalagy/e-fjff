	...
	<div class="col-md-7 col-md-offset-3">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h3 class="panel-title">Fivondronana</h3>
			</div>
			<div class="panel-body">
				<form class="form col-md-12 center-block" id="fivondronanaForm" method="post" action="">
					<div class="form-group">
						<select class="form-control input-lg district-select" name="district">
...
$(function() {
	$(".district-select").select2({minimumResultsForSearch: 10});
});
</script>