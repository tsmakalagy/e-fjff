						...
						<tbody>
							...
							<tr id="row-<?php echo $item['id']; ?>">
								...
								<?php } else {?>
									<td> - </td>
								<?php }?>
								<td><a class="btn btn-sm btn-primary" href="<?php echo site_url('fokotany/edit/birao/' . $item['id']); ?>"><i class="fa fa-edit"></i> &Eacute;diter</a> <a class="btn btn-sm btn-warning and_delete" href="#"><i class="fa fa-trash-o"></i> Supprimer</a></td>
							</tr>		
							<?php }?>
						</tbody>
					<?php } else {?>
			                ...
			                success: function(res) {
			        			...
			        			if (res.success == true) {
				        			if (tr.siblings().length == 1) {
					        			tr.html('<td colspan="3">Pas de birao.</td>');
				        			} else {					        			
			                    		tr.remove();
				        			}
			                    } else {
