	...
	<div class="container">
        ...
        <div class="navbar-collapse collapse" id="navbar-main">
          	<ul class="nav navbar-nav">
            	<li class="dropdown">
              		<a class="dropdown-toggle" data-toggle="dropdown" href="http://bootswatch.com/cerulean/#" id="themes">Themes <span class="caret"></span></a>
              		<ul class="dropdown-menu" aria-labelledby="themes">
		                <li><a href="http://bootswatch.com/default/">Default</a></li>
		                <li class="divider"></li>
		                <li><a href="http://bootswatch.com/amelia/">Amelia</a></li>
		                <li><a href="./Bootswatch  Cerulean_files/Bootswatch  Cerulean.html">Cerulean</a></li>
	            ...
	            <li class="dropdown">
	              	<a class="dropdown-toggle" data-toggle="dropdown" href="http://bootswatch.com/cerulean/#" id="download">Download <span class="caret"></span></a>
	              	<ul class="dropdown-menu" aria-labelledby="download">
		                <li><a href="http://bootswatch.com/cerulean/bootstrap.min.css">bootstrap.min.css</a></li>
		                <li><a href="http://bootswatch.com/cerulean/bootstrap.css">bootstrap.css</a></li>
		                <li class="divider"></li>
		                <li><a href="http://bootswatch.com/cerulean/variables.less">variables.less</a></li>
		                <li><a href="http://bootswatch.com/cerulean/bootswatch.less">bootswatch.less</a></li>
	              	</ul>
	            </li><!-- / li.dropdown -->
          	</ul><!-- / ul.navbar-nav -->
